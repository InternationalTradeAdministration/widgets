	...
	function main() { 
	    $(document).ready(function($) {
	      ...
	      form += ('<p class="widget-title">Trade Events</p>');
				...
				form += ('<div><form id="myForm"><input type="button" class="search-button3" onclick="myFunction()" value="Reset"></form></form><script>function myFunction(){document.getElementById("myForm").reset();}</script></div>');
